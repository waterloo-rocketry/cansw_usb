...
int main() {
    ...
    if (last_can_msg.sid != 0x777 || last_can_msg.data_len != 8 || last_can_msg.data[0] != 1 ||
        last_can_msg.data[1] != 2 || last_can_msg.data[2] != 3 || last_can_msg.data[3] != 4 ||
        last_can_msg.data[4] != 5 || last_can_msg.data[5] != 6 || last_can_msg.data[6] != 7 ||
    ...
    if (last_can_msg.sid != 0xFF || last_can_msg.data_len != 2 || last_can_msg.data[0] != 0xAA ||
    ...
    if (last_can_msg.sid != 0x7AB || last_can_msg.data_len != 2 || last_can_msg.data[0] != 0xCD ||
    ...
    parse_usb_string("f");
    parse_usb_string(";");
    if (last_can_msg.sid != 0x111 || last_can_msg.data_len != 2 || last_can_msg.data[0] != 0xD ||
